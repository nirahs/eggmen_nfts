...
module.exports = {
  ...
  networks: {
    ...
    ethereum: {
      url: 'https://eth-mainnet.alchemyapi.io/v2/YqeMk9Apon3PCC5sq1LNDRYn72rlmLLZ',
      accounts: [`0x${process.env.ETHEREUM_MAIN_PRIVATE_KEY}`],
      chainId: 1,
      gas: 2100000,
      gasPrice: 8000000000
    },
    rinkeby: {
      url: 'https://eth-rinkeby.alchemyapi.io/v2/8jbUEyBByQfMVssEJPjdVGgBynrfEz_E',
